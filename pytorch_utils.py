...
def update_batch_norm_fn(module: nn.Module, update_batch_norm: bool) -> None:
    bn_layers = (torch.nn.modules.batchnorm._BatchNorm,)  # PyTorch BN base class.
    if isinstance(module, bn_layers):
        if not update_batch_norm:
            ...
            module.momentum = 0.0 * module.momentum_backup
