...
def _get_system_software_info() -> Dict:
    ...
    system_software_info[
        "python_compiler"
    ] = platform.python_compiler()  # Ex. 'GCC 9.3.0'
...
def get_meta_data(workload, rng_seed: Optional[int] = None) -> Dict:
    meta_data = {}
...
def set_up_loggers(log_dir: str, configs: flags.FLAGS, hyperparameters) -> MetricLogger:
